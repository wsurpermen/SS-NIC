...
def get_config():
  ...
  config.data.dataset = "happy"
  config.data.image_size = 124
  config.data.output_size = 5   # the output_size of classify
  config.training.label = False
  config.training.encoder = 'one-hot'
  config.training.noise = 0

  config.training.batch_size = 100
  config.eval.batch_size = 100
  # fine
  config.cosine_factor = 2
  config.filter_factor = 0.671002873
  config.time_step = 54
  config.classify_lambda = 42
  config.k_nbrs = 5
  config.easy_fliter = 0.340629512
  config.best_value = 0.85942029
  ...
  model.nf = 64
  model.hidden_dims = (64,128,256,256,128,64)
