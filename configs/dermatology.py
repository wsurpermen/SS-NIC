...
def get_config():
  ...
  config.data.dataset = "dermatology"
  config.data.image_size = 34
  config.data.output_size = 6
  ...
  # fine
  config.cosine_factor = 7
  config.filter_factor = 0.798312595
  config.time_step = 200
  config.classify_lambda = 34
  config.k_nbrs = 9
  config.easy_fliter = 0.213976375
  config.best_value = 0.794538341
  # training
