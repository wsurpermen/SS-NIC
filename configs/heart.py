...
def get_config():
  ...
  config.data.dataset = "heart"
  config.data.image_size = 13
  ...
  config.filter_factor = 0.720580019
  config.time_step = 112
  config.classify_lambda = 33
  config.k_nbrs = 5
  config.easy_fliter = 0.133742863
  config.best_value = 0.855555556
  # training
