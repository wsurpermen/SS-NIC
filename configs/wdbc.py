...
def get_config():
  ...
  config.data.dataset = "wdbc"
  config.data.image_size = 30
  ...
  # fine
  config.cosine_factor = 6
  config.filter_factor = 1.497718553
  config.time_step = 109
  config.classify_lambda = 23
  config.k_nbrs = 6
  config.easy_fliter = 0.429990671
  config.best_value = 0.97537594
  # training
