...
def get_config():
  ...
  config.data.dataset = "parkinsons"
  config.data.image_size = 22
  ...
  config.filter_factor = 1.023004149
  config.time_step = 146
  config.classify_lambda = 36
  config.k_nbrs = 6
  config.easy_fliter = 0.145602282
  config.best_value = 0.877105263
  # training
