...
def get_config():
  ...
  # fine
  config.cosine_factor = 1
  config.filter_factor = 1.127066596
  config.time_step = 168
  config.classify_lambda = 41
  config.k_nbrs = 3
  config.easy_fliter = 0.372746873
  config.best_value = 0.943085106
  # training
