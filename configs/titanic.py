...
def get_config():
  ...
  # fine
  config.cosine_factor = 5
  config.filter_factor = 0.537351201
  config.time_step = 173
  config.classify_lambda = 7
  config.k_nbrs = 5
  config.easy_fliter = 0.459040612
  config.best_value = 0.545
  # training
