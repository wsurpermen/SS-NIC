...
def get_config():
  ...
  config.filter_factor = 1.347909521
  config.time_step = 162
  config.classify_lambda = 10
  config.k_nbrs = 7
  config.easy_fliter = 0.24771215
  config.best_value = 0.694036227
  # training
