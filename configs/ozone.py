...
def get_config():
  ...
  config.data.dataset = "ozone"
  config.data.image_size = 72
  ...
  config.filter_factor = 1.294805688
  config.time_step = 112
  config.classify_lambda = 20
  config.k_nbrs = 10
  config.easy_fliter = 0.347740858
  config.best_value = 0.946586988
  # training
