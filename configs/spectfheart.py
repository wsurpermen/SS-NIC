...
def get_config():
  ...
  config.data.dataset = "spectfheart"
  config.data.image_size = 44
  config.data.output_size = 2
  ...
  # fine
  config.cosine_factor = 3
  config.filter_factor = 1.043282917
  config.time_step = 111
  config.classify_lambda = 44
  config.k_nbrs = 4
  config.easy_fliter = 0.452604385
  config.best_value = 0.812820513
  # training
