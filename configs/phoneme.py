...
def get_config():
  ...
  config.data.dataset = "phoneme"
  config.data.image_size = 5
  ...
  config.filter_factor = 1.208439882
  config.time_step = 66
  config.classify_lambda = 25
  config.k_nbrs = 15
  config.easy_fliter = 0.455733231
  config.best_value = 0.781523242
  # training
