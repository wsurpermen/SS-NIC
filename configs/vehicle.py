...
def get_config():
  ...
  config.data.dataset = "vehicle"
  config.data.image_size = 18
  config.data.output_size = 4   # the output_size of classify
  ...
  config.filter_factor = 0.742149186
  config.time_step = 87
  config.classify_lambda = 1
  config.k_nbrs = 3
  config.easy_fliter = 0.486786025
  config.best_value = 0.645111134
  # training
