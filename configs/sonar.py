...
def get_config():
  ...
  config.data.dataset = "sonar"
  config.data.image_size = 60
  ...
  config.filter_factor = 0.993076098
  config.time_step = 67
  config.classify_lambda = 45
  config.k_nbrs = 11
  config.easy_fliter = 0.232012417
  config.best_value = 0.818095238
