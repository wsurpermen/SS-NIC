...
def get_config():
  ...
  config.data.dataset = "german"
  config.data.image_size = 24
  ...
  config.filter_factor = 0.500203675
  config.time_step = 70
  config.classify_lambda = 26
  config.k_nbrs = 13
  config.easy_fliter = 0.399020795
  config.best_value = 0.746
  # training
