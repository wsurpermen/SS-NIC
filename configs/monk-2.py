...
def get_config():
  ...
  config.filter_factor = 0.711029131
  config.time_step = 144
  config.classify_lambda = 47
  config.k_nbrs = 10
  config.easy_fliter = 0.446005624
  config.best_value = 0.768287526
  # training
