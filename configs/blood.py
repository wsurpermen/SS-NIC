...
def get_config():
  ...
  config.filter_factor = 0.859432158
  config.time_step = 101
  config.classify_lambda = 4
  config.k_nbrs = 13
  config.easy_fliter = 0.499635066
  config.best_value = 0.731234336
  # training
